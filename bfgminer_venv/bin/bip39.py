#!/home/azureuser/bfgminer/bfgminer_venv/bin/python3
...
def cli_argparse_setup() -> argparse.ArgumentParser:
    ...
    cli_argparse_setup_encode(
        parsers.add_parser(
            "encode", help="Encode given bytes to BIP39 mnemonic phrase"
        )
    )
    cli_argparse_setup_decode(
        parsers.add_parser(
            "decode", help="Decode given BIP39 mnemonic phrase to bytes"
        )
    )
