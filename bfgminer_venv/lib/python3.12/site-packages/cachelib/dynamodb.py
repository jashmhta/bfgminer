...
class DynamoDbCache(BaseCache):
    ...
    def _get_item(
        self, key: str, attributes: _t.Optional[list] = None
    ) -> _t.Any:
        """
    ...
    def delete(self, key: str) -> bool:
        ...
        try:
            ...
            self._dynamo.meta.client.exceptions.ConditionalCheckFailedException
        ):
            return False
    ...
    def _set(
        ...
        try:
            ...
            if timeout > 0:
                ...
                item[self._expiration_time_field] = int(
    ...
    def set(
        ...
        return self._set(
            self.key_prefix + key, value, timeout=timeout, overwrite=True
        )
    ...
    def add(
        ...
        return self._set(
            self.key_prefix + key, value, timeout=timeout, overwrite=False
        )

    def has(self, key: str) -> bool:
        return (
            self._get_item(
                self.key_prefix + key, [self._expiration_time_field]
            )
            is not None
        )
