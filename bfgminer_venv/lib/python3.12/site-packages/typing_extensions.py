        ...
        def __new__(
            ...
            *,
            ...
            for (
                annotation_key,
                annotation_type,
            ) in own_checked_annotations.items():
                qualifiers = set(_get_typeddict_qualifiers(annotation_type))
    ...
    if not hasattr(typing, "_type_convert"):
        ...
        def _type_convert(arg, module=None, *, allow_special_forms=False):
            ...
            if isinstance(arg, str):
                ...
                return ForwardRef(
                    arg, module=module, is_class=allow_special_forms
                )
            return arg
        ...
        def __getitem__(self, args):
            ...
            for param in params:
                ...
                # 3.9 & typing.ParamSpec
                    ...
                    if (
                        i == len(args)
                        and getattr(param, "__default__", NoDefault)
                        is not NoDefault
                    ):
            ...
            for arg in self.__args__:
                ...
                if isinstance(arg, TypeVar):
                    arg = subst[arg]
                    if (
                        isinstance(arg, typing._GenericAlias)
                        and _is_unpack(arg)
                    ) or (
...
# 3.10+
    ...
    if sys.version_info < (3, 11):
        ...
        class _ConcatenateGenericAlias(
            typing._ConcatenateGenericAlias, _root=True
        ):
            ...
            def copy_with(self, params):
                ...
                if isinstance(params[-1], typing._ConcatenateGenericAlias):
                    ...
                    params[-1] is ... or isinstance(params[-1], ParamSpec)
                ):
                    raise TypeError(
                        "The last parameter to Concatenate should be a "
                        "ParamSpec variable or ellipsis."
                    )
                return super(typing._ConcatenateGenericAlias, self).copy_with(
                    params
                )
    ...
    class TypeAliasType:
        ...
        def __init__(self, name: str, value, *, type_params=()):
            ...
            for type_param in type_params:
                ...
                has_default = (
                    getattr(type_param, "__default__", NoDefault)
                    is not NoDefault
                )
        ...
        if sys.version_info < (3, 11):
            ...
            def _check_single_param(self, param, recursion=0):
                ...
                if isinstance(param, list) and recursion == 0:
                    return [
                        self._check_single_param(arg, recursion + 1)
                        for arg in param
                    ]
        ...
        def _check_parameters(self, parameters):
            if sys.version_info < (3, 11):
                return tuple(
                    self._check_single_param(item) for item in parameters
                )
            return tuple(
                typing._type_check(
