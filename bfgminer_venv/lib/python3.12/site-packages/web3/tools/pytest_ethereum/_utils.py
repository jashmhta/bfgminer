...
def pluck_matching_uri(
    deployment_data: Dict[URI, Dict[str, str]], w3: Web3
) -> URI:
    """
...
def contains_matching_uri(
    deployment_data: Dict[str, Dict[str, str]], w3: Web3
) -> bool:
    """
...
def insert_deployment(
    ...
    if old_deployments_data and contains_matching_uri(
        old_deployments_data, package.w3
    ):
...
def create_deployment_data(
    ...
    if link_refs:
        yield "runtimeBytecode", {
            "linkDependencies": create_link_dep(link_refs)
        }
