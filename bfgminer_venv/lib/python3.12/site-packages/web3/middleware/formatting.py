...
def _apply_response_formatters(
    ...
    def _format_response(
        ...
        if response_type == "params":
            appropriate_response = cast(
                EthSubscriptionParams, response[response_type]
            )
            return assoc(
                response,
                response_type,
            ...
            return assoc(
                response,
                response_type,
                method_response_formatter(appropriate_response),
            )
    ...
    async def formatter_middleware(
        ...
        async def middleware(
            ...
            if async_w3.provider.has_persistent_connection:
                ...
                provider = cast(
                    "PersistentConnectionProvider", async_w3.provider
                )
