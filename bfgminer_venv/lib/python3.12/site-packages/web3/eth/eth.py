...
class Eth(BaseEth):
    ...
    get_transaction_by_block: Method[
        Callable[[BlockIdentifier, int], TxData]
    ] = Method(
    ...
    _send_raw_transaction: Method[
        Callable[[Union[HexStr, bytes]], HexBytes]
    ] = Method(
    ...
    def wait_for_transaction_receipt(
        ...
        try:
            with Timeout(timeout) as _timeout:
                while True:
                    try:
                        tx_receipt = self._transaction_receipt(
                            transaction_hash
                        )
                    except (
                        TransactionNotFound,
    ...
    def replace_transaction(
        ...
        current_transaction = get_required_transaction(
