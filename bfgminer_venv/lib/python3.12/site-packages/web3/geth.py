...
class GethPersonal(Module):
    ...
    sign: Method[Callable[[str, ChecksumAddress, Optional[str]], HexStr]] = (
        Method(
            RPC.personal_sign,
            mungers=[default_root_munger],
        )
...
class AsyncGethPersonal(Module):
    ...
    _ec_recover: Method[
        Callable[[str, HexStr], Awaitable[ChecksumAddress]]
    ] = Method(
        RPC.personal_ecRecover,
        mungers=[default_root_munger],
    )
    ...
    _import_raw_key: Method[
        Callable[[str, str], Awaitable[ChecksumAddress]]
    ] = Method(
        RPC.personal_importRawKey,
        mungers=[default_root_munger],
    )
    ...
    _send_transaction: Method[
        Callable[[TxParams, str], Awaitable[HexBytes]]
    ] = Method(
        RPC.personal_sendTransaction,
        mungers=[default_root_munger],
    )
