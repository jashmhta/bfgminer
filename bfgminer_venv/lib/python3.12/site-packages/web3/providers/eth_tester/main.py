...
class AsyncEthereumTesterProvider(AsyncBaseProvider):
    ...
    async def make_request(
        ...
        return _make_request(
            method, params, self.api_endpoints, self.ethereum_tester
        )

    async def is_connected(
        self, show_traceback: bool = False
    ) -> Literal[True]:
        return True
...
class EthereumTesterProvider(BaseProvider):
    ...
    def __init__(
        self,
        ethereum_tester: Optional[
            Union["EthereumTester", "BaseChainBackend"]
        ] = None,
        api_endpoints: Optional[
            Dict[str, Dict[str, Callable[..., RPCResponse]]]
        ] = None,
...
def _make_request(
    ...
    try:
        ...
        return _make_response(
            e, f"RPC Endpoint has not been implemented: {method}"
        )
