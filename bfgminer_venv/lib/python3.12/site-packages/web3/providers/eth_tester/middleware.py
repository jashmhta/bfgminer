...
request_formatters = {
    ...
    RPCEndpoint("eth_getFilterChanges"): apply_formatters_to_args(
        hex_to_integer
    ),
    ...
    RPCEndpoint("eth_uninstallFilter"): apply_formatters_to_args(
        hex_to_integer
    ),
...
def default_transaction_fields_middleware(
    ...
    def middleware(method: RPCEndpoint, params: Any) -> RPCResponse:
        if method in (
            ...
            return make_request(
                method, [filled_transaction] + list(params)[1:]
            )
        else:
