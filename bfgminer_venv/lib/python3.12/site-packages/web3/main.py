...
class BaseWeb3:
    ...
    @wraps(to_wei)
    def to_wei(
        number: Union[int, float, str, decimal.Decimal], unit: str
    ) -> Wei:
    ...
    def strict_bytes_type_checking(
        self, strict_bytes_type_check: bool
    ) -> None:
        self.codec = (
    ...
    @combomethod
    def solidity_keccak(
        cls, abi_types: List[TypeStr], values: List[Any]
    ) -> bytes:
        """
...
class _PersistentConnectionWeb3(AsyncWeb3):
    ...
    def __init__(
        ...
        AsyncWeb3.__init__(
            self, provider, middlewares, modules, external_modules, ens
        )
