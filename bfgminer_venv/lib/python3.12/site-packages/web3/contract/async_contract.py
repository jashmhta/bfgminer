...
class AsyncContractEvent(BaseContractEvent):
    ...
    async def get_logs(
        ...
        if argument_filters is not None:
            ...
            if not all(
                arg in event_arg_names for arg in argument_filters.keys()
            ):
    ...
    async def create_filter(
        ...
        *,  # PEP 3102
        ...
        """
        filter_builder = AsyncEventFilterBuilder(
            self._get_event_abi(), self.w3.codec
        )
...
class AsyncContractFunctions(BaseContractFunctions):
    def __init__(
        ...
        super().__init__(
            abi, w3, AsyncContractFunction, address, decode_tuples
        )
...
class AsyncContract(BaseContract):
    ...
    def constructor(cls, *args: Any, **kwargs: Any) -> Self:
        ...
        return AsyncContractConstructor(
            cls.w3, cls.abi, cls.bytecode, *args, **kwargs
        )
...
class AsyncContractConstructor(BaseContractConstructor):
    ...
    async def transact(
        ...
        return await self.w3.eth.send_transaction(
