...
class IntegerBase:
    ...
    def __floordiv__(
        self, divisor: Union[IntegerBase, int]
    ) -> IntegerBase: ...
    ...
    def __pow__(
        self, exponent: int, modulus: Optional[int]
    ) -> IntegerBase: ...
    ...
    def fail_if_divisible_by(
        self, small_prime: Union[IntegerBase, int]
    ) -> None: ...
    ...
    def inplace_inverse(
        self, modulus: Union[IntegerBase, int]
    ) -> IntegerBase: ...
