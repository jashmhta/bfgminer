...
class LongTests(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.assertEqual(
            long_to_bytes(0x112233445566778899),
    ...
    def test2(self):
        ...
        self.assertEqual(
            long_to_bytes(0xFF00000001, 6), b"\x00\xff\x00\x00\x00\x01"
        )
        self.assertEqual(
            long_to_bytes(0xFF00000001, 8), b"\x00\x00\x00\xff\x00\x00\x00\x01"
        )
        self.assertEqual(
            long_to_bytes(0xFF00000001, 10),
            b"\x00\x00\x00\x00\x00\xff\x00\x00\x00\x01",
        )
        self.assertEqual(
