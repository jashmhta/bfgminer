...
class CheckParity(unittest.TestCase):
    ...
    def test_parity_option2(self):
        ...
        self.assertEqual(
            after_2k, unhexlify("CBBF326EA46734324FFDCBBCDFFBCBBF")
        )
    ...
    def test_degradation(self):
        ...
        # K1 == K2
        self.assertRaises(
            ValueError, DES3.adjust_key_parity, sub_key1 * 2 + sub_key2
        )

        # K2 == K3
        self.assertRaises(
            ValueError, DES3.adjust_key_parity, sub_key1 + sub_key2 * 2
        )
...
class DegenerateToDESTest(unittest.TestCase):
    ...
    def runTest(self):
        ...
        # K1 == K2
        self.assertRaises(
            ValueError, DES3.new, sub_key1 * 2 + sub_key2, DES3.MODE_ECB
        )

        # K2 == K3
        self.assertRaises(
            ValueError, DES3.new, sub_key1 + sub_key2 * 2, DES3.MODE_ECB
        )
