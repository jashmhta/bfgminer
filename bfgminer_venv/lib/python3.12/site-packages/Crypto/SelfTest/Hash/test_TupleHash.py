...
class TupleHashTest(unittest.TestCase):
    ...
    def test_new_negative(self):
        ...
        for new_func in self.TupleHash.new, h.new:
            ...
            self.assertRaises(
                ValueError, new_func, digest_bits=self.minimum_bits + 7
            )
            self.assertRaises(
                ValueError, new_func, digest_bits=self.minimum_bits - 8
            )
            self.assertRaises(
                ValueError, new_func, digest_bits=self.minimum_bytes - 1
            )
