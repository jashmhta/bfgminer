...
class RSATest(unittest.TestCase):
    ...
    def test_construct_6tuple(self):
        ...
        rsaObj = self.rsa.construct(
            (self.n, self.e, self.d, self.p, self.q, self.u)
        )
        self._check_private_key(rsaObj)
        self._check_encryption(rsaObj)
        self._check_decryption(rsaObj)
    ...
    def test_factoring(self):
        ...
        self.assertRaises(
            ValueError, self.rsa.construct, [self.n, self.e, self.n - 1]
        )
    ...
    def _check_public_key(self, rsaObj):
        ...
        self.assertRaises(
            TypeError, rsaObj._decrypt, bytes_to_long(ciphertext)
        )
        self.assertRaises(
        ...
        self.assertEqual(
            rsaObj.public_key() == rsaObj.public_key(), True
        )  # assert_
        self.assertEqual(
