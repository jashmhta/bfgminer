...
class LengthTests(TestCase):
    ...
    def test_regex(self):
        ...
        self.assertRaises(
            ParseError, Regex("hello*").match, "goodbye"
        )  # no match
    ...
    def test_one_of(self):
        ...
        self.len_eq(
            OneOf(Literal("aaa"), Literal("bb")).match("bbaaa"), 2
        )  # second
        self.assertRaises(
...
class TreeTests(TestCase):
    ...
    def test_optional(self):
        ...
        self.assertEqual(
            expr.match(text),
            Node(
                expr, text, 0, 1, children=[Node(expr.members[0], text, 0, 1)]
            ),
        )
...
class ErrorReportingTests(TestCase):
    ...
    def test_line_and_column(self):
        ...
        try:
            ...
            self.assertTrue(
                str(error).endswith(
                    r"""didn't match at 'GOO' (line 2, column 4)."""
                )
            )
...
class SlotsTests(TestCase):
    ...
    def test_subclassing(self):
        ...
        self.assertEqual(
            smoo.__dict__, {}
        )  # has a __dict__ but with no smoo in it
        self.assertEqual(
            smoo.smoo, "smoo"
        )  # The smoo attr ended up in a slot.
