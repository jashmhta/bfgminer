...
class BootstrappingGrammarTests(TestCase):
    ...
    def test_successes(self):
        ...
        self.assertTrue(
            rule_grammar["expression"].parse('&this / that+ / "other"')
        )
        self.assertTrue(
            rule_grammar["expression"].parse('this / that? / "other"+')
        )
        ...
        self.assertTrue(
            rule_grammar["rule"].parse("this = the? that other* \t\r")
        )
...
class RuleVisitorTests(TestCase):
    ...
    def test_round_trip(self):
        ...
        text = "98"
        self.assertEqual(
            default_rule.parse(text), Node(default_rule, text, 0, 2)
        )
...
class GrammarTests(TestCase):
    ...
    def test_unconnected_custom_rules(self):
        ...
        """
        grammar = Grammar(one_char=lambda text, pos: pos + 1).default(
            "one_char"
        )
        s = "4"
