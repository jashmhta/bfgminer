...
def test_is_valid(check_valid=is_valid_args, incomplete=False):
    ...
    check_valid = lambda func, *args, **kwargs: orig_check_valid(
        func, args, kwargs
    )
...
def test_introspect_curry_valid_py3(
    check_valid=is_valid_args, incomplete=False
):
    orig_check_valid = check_valid
...
def test_introspect_curry_partial_py3():
    test_introspect_curry_valid_py3(
        check_valid=is_partial_args, incomplete=True
    )
