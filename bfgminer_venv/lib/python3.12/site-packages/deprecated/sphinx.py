...
class SphinxAdapter(ClassicAdapter):
    ...
    def __call__(self, wrapped):
        ...
        div_lines = [
            fmt.format(directive=self.directive, version=self.version)
        ]
        ...
        docstring = (
            textwrap.dedent("".join(lines[1:])) if len(lines) > 1 else ""
        )
...
def deprecated(reason="", version="", line_length=70, **kwargs):
    ...
    return _classic_deprecated(
        directive=directive, adapter_cls=adapter_cls, **kwargs
    )
