...
class ABIRegistry(Copyable, BaseRegistry):
    def __init__(self):
        ...
        self.get_encoder = functools.lru_cache(maxsize=None)(
            self._get_encoder_uncached
        )
        self.get_decoder = functools.lru_cache(maxsize=None)(
            self._get_decoder_uncached
        )
