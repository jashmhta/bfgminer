...
class ListSerializationError(SerializationError):
    ...
    def __init__(
        self, message=None, obj=None, element_exception=None, index=None
    ):
        if message is None:
...
class ObjectSerializationError(SerializationError):
    ...
    def __init__(
        self, message=None, obj=None, sedes=None, list_exception=None
    ):
        if message is None:
            ...
            if list_exception.element_exception is None:
                ...
                message = (
                    "Serialization failed because of field {} "
                    '("{}")'.format(
...
class ListDeserializationError(DeserializationError):
    ...
    def __init__(
        self, message=None, serial=None, element_exception=None, index=None
    ):
        if not message:
            assert index is not None
            assert element_exception is not None
...
class ObjectDeserializationError(DeserializationError):
    ...
    def __init__(
        self, message=None, serial=None, sedes=None, list_exception=None
    ):
        if not message:
            assert list_exception is not None
            if list_exception.element_exception is None:
                ...
                field = sedes._meta.field_names[list_exception.index]
                message = (
                    "Deserialization failed because of field {} "
                    '("{}")'.format(
                        field, str(list_exception.element_exception)
                    )
                )
