...
def consume_length_prefix(rlp, start):
    ...
    if b0 < 128:  # single byte
        ...
        if l < 56:
            raise DecodingError(
                "Long string prefix used for short string", rlp
            )
...
def infer_sedes(obj):
    ...
    if is_sedes(obj.__class__):
        ...
        return binary
    elif not isinstance(obj, str) and isinstance(
