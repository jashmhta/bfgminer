...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _FILEDESCRIPTORSET.fields_by_name["file"].message_type = (
        _FILEDESCRIPTORPROTO
    )
    _FILEDESCRIPTORPROTO.fields_by_name["message_type"].message_type = (
        _DESCRIPTORPROTO
    )
    _FILEDESCRIPTORPROTO.fields_by_name["enum_type"].message_type = (
    ...
    _DESCRIPTORPROTO.fields_by_name["field"].message_type = (
        _FIELDDESCRIPTORPROTO
    )
    _DESCRIPTORPROTO.fields_by_name["extension"].message_type = (
        _FIELDDESCRIPTORPROTO
    )
    _DESCRIPTORPROTO.fields_by_name["nested_type"].message_type = (
        _DESCRIPTORPROTO
    )
    _DESCRIPTORPROTO.fields_by_name["enum_type"].message_type = (
        _ENUMDESCRIPTORPROTO
    )
    _DESCRIPTORPROTO.fields_by_name["extension_range"].message_type = (
        _DESCRIPTORPROTO_EXTENSIONRANGE
    )
    _DESCRIPTORPROTO.fields_by_name["oneof_decl"].message_type = (
    ...
    _EXTENSIONRANGEOPTIONS.fields_by_name["features"].message_type = (
        _FEATURESET
    )
    _EXTENSIONRANGEOPTIONS.fields_by_name["verification"].enum_type = (
        _EXTENSIONRANGEOPTIONS_VERIFICATIONSTATE
    )
    _EXTENSIONRANGEOPTIONS_VERIFICATIONSTATE.containing_type = (
        _EXTENSIONRANGEOPTIONS
    )
    _FIELDDESCRIPTORPROTO.fields_by_name["label"].enum_type = (
        _FIELDDESCRIPTORPROTO_LABEL
    )
    _FIELDDESCRIPTORPROTO.fields_by_name["type"].enum_type = (
        _FIELDDESCRIPTORPROTO_TYPE
    )
    _FIELDDESCRIPTORPROTO.fields_by_name["options"].message_type = (
        _FIELDOPTIONS
    )
    ...
    _ONEOFDESCRIPTORPROTO.fields_by_name["options"].message_type = (
        _ONEOFOPTIONS
    )
    _ENUMDESCRIPTORPROTO_ENUMRESERVEDRANGE.containing_type = (
        _ENUMDESCRIPTORPROTO
    )
    ...
    _ENUMDESCRIPTORPROTO.fields_by_name["visibility"].enum_type = (
        _SYMBOLVISIBILITY
    )
    _ENUMVALUEDESCRIPTORPROTO.fields_by_name["options"].message_type = (
        _ENUMVALUEOPTIONS
    )
    _SERVICEDESCRIPTORPROTO.fields_by_name["method"].message_type = (
        _METHODDESCRIPTORPROTO
    )
    _SERVICEDESCRIPTORPROTO.fields_by_name["options"].message_type = (
        _SERVICEOPTIONS
    )
    _METHODDESCRIPTORPROTO.fields_by_name["options"].message_type = (
        _METHODOPTIONS
    )
    _FILEOPTIONS.fields_by_name["optimize_for"].enum_type = (
        _FILEOPTIONS_OPTIMIZEMODE
    )
    ...
    _FIELDOPTIONS.fields_by_name["retention"].enum_type = (
        _FIELDOPTIONS_OPTIONRETENTION
    )
    _FIELDOPTIONS.fields_by_name["targets"].enum_type = (
        _FIELDOPTIONS_OPTIONTARGETTYPE
    )
    ...
    _FEATURESET.fields_by_name["field_presence"].enum_type = (
        _FEATURESET_FIELDPRESENCE
    )
    ...
    _FEATURESET.fields_by_name["utf8_validation"].enum_type = (
        _FEATURESET_UTF8VALIDATION
    )
    _FEATURESET.fields_by_name["message_encoding"].enum_type = (
        _FEATURESET_MESSAGEENCODING
    )
    _FEATURESET.fields_by_name["json_format"].enum_type = (
        _FEATURESET_JSONFORMAT
    )
    ...
    _FEATURESETDEFAULTS_FEATURESETEDITIONDEFAULT.containing_type = (
        _FEATURESETDEFAULTS
    )
    ...
    _SOURCECODEINFO.fields_by_name["location"].message_type = (
        _SOURCECODEINFO_LOCATION
    )
    ...
    DESCRIPTOR.message_types_by_name["FileDescriptorProto"] = (
        _FILEDESCRIPTORPROTO
    )
    DESCRIPTOR.message_types_by_name["DescriptorProto"] = _DESCRIPTORPROTO
    DESCRIPTOR.message_types_by_name["ExtensionRangeOptions"] = (
        _EXTENSIONRANGEOPTIONS
    )
    DESCRIPTOR.message_types_by_name["FieldDescriptorProto"] = (
        _FIELDDESCRIPTORPROTO
    )
    DESCRIPTOR.message_types_by_name["OneofDescriptorProto"] = (
        _ONEOFDESCRIPTORPROTO
    )
    DESCRIPTOR.message_types_by_name["EnumDescriptorProto"] = (
        _ENUMDESCRIPTORPROTO
    )
    DESCRIPTOR.message_types_by_name["EnumValueDescriptorProto"] = (
        _ENUMVALUEDESCRIPTORPROTO
    )
    DESCRIPTOR.message_types_by_name["ServiceDescriptorProto"] = (
        _SERVICEDESCRIPTORPROTO
    )
    DESCRIPTOR.message_types_by_name["MethodDescriptorProto"] = (
        _METHODDESCRIPTORPROTO
    )
    ...
    DESCRIPTOR.message_types_by_name["UninterpretedOption"] = (
        _UNINTERPRETEDOPTION
    )
    DESCRIPTOR.message_types_by_name["FeatureSet"] = _FEATURESET
    DESCRIPTOR.message_types_by_name["FeatureSetDefaults"] = (
        _FEATURESETDEFAULTS
    )
    ...
    DESCRIPTOR._features = _ResolvedFeatures(
        ...
        utf8_validation=_FEATURESET_UTF8VALIDATION.values_by_name[
            "NONE"
        ].number,
    ...
    _ENUMDESCRIPTORPROTO_ENUMRESERVEDRANGE.fields[0]._features = (
        _ResolvedFeatures(
            field_presence=_FEATURESET_FIELDPRESENCE.values_by_name[
                "EXPLICIT"
            ].number,
    ...
    _ENUMDESCRIPTORPROTO_ENUMRESERVEDRANGE.fields[1]._features = (
        _ResolvedFeatures(
            field_presence=_FEATURESET_FIELDPRESENCE.values_by_name[
                "EXPLICIT"
            ].number,
    ...
    _EXTENSIONRANGEOPTIONS_VERIFICATIONSTATE.values[0]._features = (
        _ResolvedFeatures(
            field_presence=_FEATURESET_FIELDPRESENCE.values_by_name[
                "EXPLICIT"
            ].number,
    ...
    _EXTENSIONRANGEOPTIONS_VERIFICATIONSTATE.values[1]._features = (
        _ResolvedFeatures(
            field_presence=_FEATURESET_FIELDPRESENCE.values_by_name[
                "EXPLICIT"
            ].number,
    ...
    _GENERATEDCODEINFO_ANNOTATION_SEMANTIC.values[0]._features = (
        _ResolvedFeatures(
            field_presence=_FEATURESET_FIELDPRESENCE.values_by_name[
                "EXPLICIT"
            ].number,
    ...
    _GENERATEDCODEINFO_ANNOTATION_SEMANTIC.values[1]._features = (
        _ResolvedFeatures(
            field_presence=_FEATURESET_FIELDPRESENCE.values_by_name[
                "EXPLICIT"
            ].number,
    ...
    _GENERATEDCODEINFO_ANNOTATION_SEMANTIC.values[2]._features = (
        _ResolvedFeatures(
            field_presence=_FEATURESET_FIELDPRESENCE.values_by_name[
                "EXPLICIT"
            ].number,
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_FIELDOPTIONS"].fields_by_name[
        "weak"
    ]._serialized_options = b"\030\001"
    ...
    _globals["_EXTENSIONRANGEOPTIONS_VERIFICATIONSTATE"]._serialized_start = (
        2279
    )
    ...
    _globals["_GENERATEDCODEINFO_ANNOTATION_SEMANTIC"]._serialized_start = (
        12628
    )
