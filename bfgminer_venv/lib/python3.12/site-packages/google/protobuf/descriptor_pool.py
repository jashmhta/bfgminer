...
class DescriptorPool(object):
    ...
    def _AddEnumDescriptor(self, enum_desc):
        ...
        if enum_desc.file.package:
            top_level = (
                enum_desc.full_name.count(".")
                - enum_desc.file.package.count(".")
                == 1
            )
        else:
            ...
            try:
                ...
                if isinstance(all_numbers, list):
                    for number in all_numbers:
                        if (
                            number
                            in self._extensions_by_number[message_descriptor]
                        ):
                            continue
                        self._TryLoadExtensionFromDB(
    ...
    def _ConvertMessageDescriptor(
        ...
        extension_ranges = [
            (r.start, r.end) for r in desc_proto.extension_range
        ]
        if extension_ranges:
            is_extendable = True
        else:
    ...
    def _SetFieldType(self, field_proto, field_desc, package, scope):
        ...
        field_desc.cpp_type = (
            descriptor.FieldDescriptor.ProtoTypeToCppProtoType(
                field_proto.type
            )
        )
        ...
        if field_proto.label == descriptor.FieldDescriptor.LABEL_REPEATED:
            ...
            if (
                ...
                field_desc.default_value = (
                    field_proto.default_value.lower() == "true"
                )
            ...
            if (
                ...
                field_desc.default_value = field_desc.enum_type.values[
                    0
                ].number
            elif field_proto.type == descriptor.FieldDescriptor.TYPE_BYTES:
