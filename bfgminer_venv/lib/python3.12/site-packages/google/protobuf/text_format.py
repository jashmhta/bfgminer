...
class _Printer(object):
    ...
    def _TryPrintAsAnyMessage(self, message):
        ...
        if packed_message is not None:
            ...
            self.out.write(
                "%s[%s]%s " % (self.indent * " ", message.type_url, colon)
            )
        ...
        for field in unknown_field_set:
            ...
            if field.wire_type == WIRETYPE_START_GROUP:
                ...
                try:
                    ...
                    (embedded_unknown_message, pos) = (
                        decoder._DecodeUnknownFieldSet(
...
class _Parser(object):
    ...
    def _DetectSilentMarker(
        self, tokenizer, immediate_message_type, field_name
    ):
    ...
    def _MergeMessageField(self, tokenizer, message, field):
        ...
        if field.is_repeated:
            ...
            if field.is_extension:
                if not self._allow_multiple_scalars and message.HasExtension(
                    field
                ):
                    raise tokenizer.ParseErrorPreviousToken(
                ...
                if not self._allow_multiple_scalars and message.HasField(
                    field.name
                ):
                    raise tokenizer.ParseErrorPreviousToken(
    ...
    def _SkipFieldContents(
        self, tokenizer, field_name, immediate_message_type
    ):
