...
class _Printer(object):
        ...
        try:
            for field, value in fields:
                ...
                if _IsMapEntry(field):
                    ...
                    js[name] = [
                        self._FieldToJsonObject(field, k) for k in value
                    ]
    ...
    def _AnyMessageToJsonObject(self, message):
        ...
        if _IsWrapperMessage(message_descriptor):
            ...
            return js
        if full_name in _WKTJSONMETHODS:
            js["value"] = methodcaller(
                _WKTJSONMETHODS[full_name][0], sub_message
            )(self)
            return js
    ...
    def _ListValueMessageToJsonObject(self, message):
        ...
        return [
            self._ValueMessageToJsonObject(value) for value in message.values
        ]
...
class _Parser(object):
    ...
    def ConvertMessage(self, value, message, path):
        ...
        if _IsWrapperMessage(message_descriptor):
            ...
            methodcaller(_WKTJSONMETHODS[full_name][1], value, message, path)(
                self
            )
        else:
    ...
    def _ConvertValueMessage(self, value, message, path):
        ...
        if isinstance(value, dict):
            ...
            self._ConvertListOrTupleValueMessage(
                value, message.list_value, path
            )
        elif value is None:
