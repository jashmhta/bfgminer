...
class IOBasePayload(Payload):
    ...
    def _read_and_available_len(
        ...
        return size, self._value.read(
            min(
                READ_SIZE,
                size or READ_SIZE,
                remaining_content_len or READ_SIZE,
            )
        )
    ...
    def size(self) -> Optional[int]:
        ...
        try:
            ...
            return (
                os.fstat(self._value.fileno()).st_size - self._start_position
            )
    ...
    def _should_stop_writing(
        ...
        ) or (remaining_content_len is not None and remaining_content_len <= 0)
...
class AsyncIterablePayload(Payload):
    ...
    async def write_with_length(
        ...
        try:
            ...
            self._iter = None
            self._consumed = (
                True  # Mark as consumed when streamed without caching
            )
