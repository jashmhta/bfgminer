...
class Package(object):
    def __init__(
        ...
        self.w3 = w3
        self.w3.eth._default_contract_factory = cast(
            Type[Contract], LinkableContract
        )
    ...
    def contract_types(self) -> List[str]:
        ...
        if "contractTypes" in self.manifest:
            ...
            raise ValueError(
                "No contract types found in manifest; {self.__repr__()}."
            )
    ...
    def get_contract_instance(
        self, name: ContractName, address: Address
    ) -> Contract:
        """
