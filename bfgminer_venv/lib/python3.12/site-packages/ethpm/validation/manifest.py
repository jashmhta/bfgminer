...
def validate_meta_object(
    meta: Dict[str, Any], allow_extra_meta_fields: bool
) -> None:
    """
...
def extract_contract_types_from_deployments(
    deployment_data: List[Any],
) -> Set[str]:
    contract_types = {
...
def validate_manifest_deployments(manifest: Dict[str, Any]) -> None:
    ...
    if {"contractTypes", "deployments"}.issubset(manifest):
        ...
        all_deployment_names = extract_contract_types_from_deployments(
            all_deployments
        )
