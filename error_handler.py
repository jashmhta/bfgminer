...
class BFGMinerException(Exception):
    ...
    def __init__(self, message: str, error_code: int, details: Dict[str, Any] = None, 
                 http_status: int = 400):
        ...
        try:
            ...
            if self.audit_logger:
                self.audit_logger.log_security_event(
                    ...
                    severity="HIGH" if isinstance(error, BFGMinerException) and error.http_status >= 500 else "MEDIUM",
